...
and called fresh_tomatoes.open_movies_page(movies)
"""

roaring_currents = media.Movie(
    "Roaring Currents",
    "Based on the true story of the greatest naval battle in history",
    "https://upload.wikimedia.org/wikipedia/en/3/3a/Battle_of_Myeongryang_poster.jpg",  # noqa
    "https://www.youtube.com/watch?v=VfYO-t5e40s")

captain_america_cw = media.Movie(
    "Captain America",
    "Marvel Comics crossover storyline",
    "https://upload.wikimedia.org/wikipedia/en/5/53/Captain_America_Civil_War_poster.jpg",  # noqa
    "https://www.youtube.com/watch?v=dKrVegVI0Us")

masquerade = media.Movie(
    "Masquerade",
    "The Man Who Became King",
    "https://upload.wikimedia.org/wikipedia/en/8/85/Gwanghae.jpg",  # noqa
